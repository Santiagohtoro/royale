<?php
// Incluir archivo de conexionala base de datos
require_once "conexion.php";

// Definir variableeinicializar con valores vacio
$username= "";
$correo = "";
$password ="";
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
 ...
 if (empty(trim($_POST["email"]))) {
    $email_err = "Por favor,ingrese un correo valido";
} else {
    // prepara una declaracion de seleccion
...
if(empty(trim($_POST["password"]))){
    ...
    $password_err="La contraseña debe de tener al menos4caracteres";
}else{
